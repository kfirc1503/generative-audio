...
#                 curr_pc_spec = utils.crm_to_spectogram(curr_pc_crm, noisy_complex)
#
#                 # Convert to magnitude spectrogram (in dB)
#                 mag_spec = torch.abs(curr_pc_spec)
#                 mag_spec_db = 20 * torch.log10(mag_spec + 1e-8)
#
#                 specs.append(mag_spec_db)
#                 # specs.append(curr_pc_spec)
#             return specs
#
...
#             stft_config = self.config.nppc_audio_model_configuration.stft_configuration
#             self.save_audio_files(audio_dir, noisy, clean_audio, enhanced_complex, stft_config)
#
#
#             # Create visualization
